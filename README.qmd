...
This crate contains an implementation of the 'jittering' technique for pre-processing origin-destination (OD) data, plus code for conversion of aggregate OD data to disaggregate trip level data, with movement between two points represented as geographic lines that can be stored as GeoJSON files.
