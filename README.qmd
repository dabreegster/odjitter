...
You can call the Rust code from R, as illustrated by the code below which generates the figure below.

```{r thresholddemo, fig.show='hold', out.width="30%", message=FALSE}
